...
| owner | <code>String</code> |  | The handle of the owner organization |
| [options] | <code>Object</code> | <code>{}</code> | extra pine options to use |
...
| [options.organization] | <code>String</code> \| <code>Number</code> \| <code>null</code> | handle (string) or id (number) of the organization that the application will belong to or null |
...
This method creates a new organization with current user as an administrator.
